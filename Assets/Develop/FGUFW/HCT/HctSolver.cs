...
namespace FGUFW.HCT
{
    ...
    {
        public readonly static double[][] LINRGB_FROM_SCALED_DISCOUNT = new double[][] 
        {
        ...
        public readonly static double[] Y_FROM_LINRGB = new double[] { 0.2126, 0.7152, 0.0722 };

        public readonly static double[][] SCALED_DISCOUNT_FROM_LINRGB = new double[][] 
        {
        ...
        public readonly static double[] CRITICAL_PLANES = new double[] 
        {
        ...
        static int findResultByJ(double hueRadians, double chroma, double y)
        {
            ...
            double tInnerCoeff = 1.0 / Math.Pow(1.64 - Math.Pow(0.29, viewingConditions.N), 0.73);
        ...
        static double inverseChromaticAdaptation(double adapted)
        {
            ...
            double baseV = Math.Max(0, 27.13 * adaptedAbs / (400.0 - adaptedAbs));
            return MathUtils.Signum(adapted) * Math.Pow(baseV, 1.0 / 0.42);
        }
        ...
        {
            return new double[] {(a[0] + b[0]) / 2.0, (a[1] + b[1]) / 2f, (a[2] + b[2]) / 2.0,};
        }
